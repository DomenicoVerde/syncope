  ...
  <xsl:template match="/wadl:application">  
    <html lang="en">
      <head>
        ...
        <link rel="stylesheet" href="{$contextPath}/webjars/jquery-ui-themes/1.12.1/smoothness/jquery-ui.min.css"/>
        <style>
          body {
        ...
        <script src="{$contextPath}/webjars/jquery/3.5.1/jquery.min.js">
        </script>
