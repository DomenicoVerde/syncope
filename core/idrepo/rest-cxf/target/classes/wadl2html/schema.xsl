  ...
  <xsl:template match="/wadl:application">  
    <html lang="en">
      <head>
        ...
        <link rel="stylesheet" href="{$contextPath}/webjars/highlightjs/9.15.10/styles/default.min.css"/>
        
        <script src="{$contextPath}/webjars/highlightjs/9.15.10/highlight.min.js">           
        </script>
        <script>
